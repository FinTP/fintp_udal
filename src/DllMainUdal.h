...
#ifdef WIN32
	#ifdef _UDALDLL
		#define ExportedUdalObject __declspec( dllexport )
		#ifdef QPAYEXT
			#define ExportedUdalObjectExt __declspec( dllexport )
		#else
			#define ExportedUdalObjectExt __declspec( dllimport )
		#endif
		//#define EXPIMP_TEMPLATE
	#else
		#define ExportedUdalObject __declspec( dllimport )
		#define ExportedUdalObjectExt __declspec( dllimport )
		//#define EXPIMP_TEMPLATE extern
	#endif
#else
	#define ExportedUdalObject 
	#define ExportedUdalObjectExt
	//#define EXPIMP_TEMPLATE
#endif
...
namespace FinTP
{
	...
	*/
	class ExportedUdalObject VersionInfo
	{
		private : 
			/// \brief Constructor
			VersionInfo(){};
